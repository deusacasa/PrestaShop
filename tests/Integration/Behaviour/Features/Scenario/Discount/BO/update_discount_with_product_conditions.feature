# ./vendor/bin/behat -c tests/Integration/Behaviour/behat.yml -s discount --tags update-discount-with-product-conditions
@restore-all-tables-before-feature
@restore-languages-after-feature
@update-discount-with-product-conditions
Feature: Update discount condition
  ...
  Scenario: Update discount with minimum products quantity
  ...
  Scenario: Update discount with restricted list of products
    ...
    Then discount "discount_with_restricted_products" should have the following properties:
      ...
      | productConditionQuantity |               |
      | productCondition         |               |
    When I update discount "discount_with_restricted_products" with the following properties:
  ...
  Scenario: Update discount with minimum amount
  ...
  Scenario: Update discount with restricted list of combinations
    ...
    Then discount "discount_with_restricted_combinations" should have the following properties:
      ...
      | productConditionQuantity |               |
      | productCondition         |               |
    When I update discount "discount_with_restricted_combinations" with the following properties:
      | productConditionQuantity       | 42                         |
  ...
  Scenario: Create discount with conditions on attributes
    ...
    Then discount "discount_with_restricted_attributes" should have the following properties:
      ...
      | productConditionQuantity |               |
      | productCondition         |               |
    When I update discount "discount_with_restricted_attributes" with the following properties:
      | productConditionQuantity     | 42      |
  ...
  Scenario: Create discount with conditions on attributes from different groups
    ...
    Then discount "discount_with_restricted_attributes_different_groups" should have the following properties:
      ...
      | productConditionQuantity |               |
      | productCondition         |               |
    When I update discount "discount_with_restricted_attributes_different_groups" with the following properties:
      | productConditionQuantity     | 42                   |
  ...
  Scenario: Create discount with multiple conditions on attributes
    ...
    Then discount "discount_with_restricted_multiple_attributes_groups" should have the following properties:
      ...
      | productConditionQuantity |               |
      | productCondition         |               |
    When I update discount "discount_with_restricted_multiple_attributes_groups" with the following properties:
      | productConditionQuantity     | 42          |
      | productCondition[attributes] | S, M, L     |
