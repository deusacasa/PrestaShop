...
use PrestaShop\PrestaShop\Core\Domain\Shipment\CommandHandler\DeleteShipmentProductFromOrderHandlerInterface;
use PrestaShop\PrestaShop\Core\Domain\Shipment\Exception\ShipmentException;
use PrestaShopBundle\Entity\Repository\ShipmentRepository;

#[AsCommandHandler]
class DeleteShipmentProductFromOrderHandler implements DeleteShipmentProductFromOrderHandlerInterface
{
    ...
    public function handle(DeleteShipmentProductFromOrder $command): void
    {
        ...
        $orderDetailId = $command->getOrderDetailId()->getValue();
